.class final Lcom/tds/lz4/LZ4JavaUnsafeCompressor;
...
.method static constructor <clinit>()V
    ...
    .line 19
    new-instance v0, Lcom/tds/lz4/LZ4JavaUnsafeCompressor;

    invoke-direct {v0}, Lcom/tds/lz4/LZ4JavaUnsafeCompressor;-><init>()V

    sput-object v0, Lcom/tds/lz4/LZ4JavaUnsafeCompressor;->INSTANCE:Lcom/tds/lz4/LZ4Compressor;
...
.method static compress64k(Ljava/nio/ByteBuffer;IILjava/nio/ByteBuffer;II)I
    ...
    .line 297
    .local v14, "h":I
    invoke-static {v3, v14}, Lcom/tds/util/UnsafeUtils;->readShort([SI)I
    ...
    invoke-static {v3, v14, v2}, Lcom/tds/util/UnsafeUtils;->writeShort([SII)V
    ...
    invoke-static {v3, v10, v4}, Lcom/tds/util/UnsafeUtils;->writeShort([SII)V
    ...
    .line 360
    .local v4, "h":I
    invoke-static {v3, v4}, Lcom/tds/util/UnsafeUtils;->readShort([SI)I
    ...
    invoke-static {v3, v4, v5}, Lcom/tds/util/UnsafeUtils;->writeShort([SII)V
...
.method static compress64k([BII[BII)I
    ...
    .line 54
    :cond_37
    invoke-static {v6, v0}, Lcom/tds/util/UnsafeUtils;->readInt([BI)I
    ...
    .line 57
    .end local v14    # "h":I
    invoke-static {v6, v1, v0}, Lcom/tds/lz4/LZ4UnsafeUtils;->readIntEquals([BII)Z
    ...
    .line 60
    invoke-static {v6, v1, v0, v7, v4}, Lcom/tds/lz4/LZ4UnsafeUtils;->commonBytesBackward([BIIII)I
    ...
    invoke-static {v9, v5, v1}, Lcom/tds/util/UnsafeUtils;->writeByte([BII)V

    .line 76
    add-int/lit8 v1, v14, -0xf

    invoke-static {v1, v9, v0}, Lcom/tds/lz4/LZ4UnsafeUtils;->writeLen(I[BI)I
    ...
    .line 82
    :goto_85
    invoke-static {v6, v4, v9, v0, v14}, Lcom/tds/lz4/LZ4UnsafeUtils;->wildArraycopy([BI[BII)V
    ...
    invoke-static {v9, v0, v4}, Lcom/tds/util/UnsafeUtils;->writeShortLE([BII)V
    ...
    .line 93
    invoke-static {v6, v1, v4, v12}, Lcom/tds/lz4/LZ4UnsafeUtils;->commonBytes([BIII)I
    ...
    .line 101
    invoke-static {v9, v5}, Lcom/tds/util/UnsafeUtils;->readByte([BI)B

    move-result v18

    or-int/lit8 v10, v18, 0xf

    invoke-static {v9, v5, v10}, Lcom/tds/util/UnsafeUtils;->writeByte([BII)V

    .line 102
    add-int/lit8 v10, v8, -0xf

    invoke-static {v10, v9, v0}, Lcom/tds/lz4/LZ4UnsafeUtils;->writeLen(I[BI)I
    ...
    invoke-static {v6, v10}, Lcom/tds/util/UnsafeUtils;->readInt([BI)I
    ...
    .line 117
    invoke-static {v6, v1}, Lcom/tds/util/UnsafeUtils;->readInt([BI)I
    ...
    .line 121
    invoke-static {v6, v1, v10}, Lcom/tds/lz4/LZ4UnsafeUtils;->readIntEquals([BII)Z
    ...
    invoke-static {v9, v0, v1}, Lcom/tds/util/UnsafeUtils;->writeByte([BII)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/tds/lz4/LZ4UnsafeUtils;->lastLiterals([BII[BII)I
...
.method public compress(Ljava/nio/ByteBuffer;IILjava/nio/ByteBuffer;II)I
    ...
    invoke-virtual/range {v7 .. v13}, Lcom/tds/lz4/LZ4JavaUnsafeCompressor;->compress([BII[BII)I
    ...
    invoke-static/range {v0 .. v5}, Lcom/tds/lz4/LZ4JavaUnsafeCompressor;->compress64k(Ljava/nio/ByteBuffer;IILjava/nio/ByteBuffer;II)I
    ...
    invoke-static {v10, v9}, Lcom/tds/util/UnsafeUtils;->readInt([II)I
    ...
    .line 429
    .local v8, "back":I
    invoke-static {v10, v9, v5}, Lcom/tds/util/UnsafeUtils;->writeInt([III)V
    ...
    invoke-static {v11, v8, v12}, Lcom/tds/util/UnsafeUtils;->writeInt([III)V
    ...
    .line 490
    .local v8, "h":I
    invoke-static {v11, v8}, Lcom/tds/util/UnsafeUtils;->readInt([II)I
    ...
    .end local v20    # "ref":I
    .local v12, "ref":I
    invoke-static {v11, v8, v1}, Lcom/tds/util/UnsafeUtils;->writeInt([III)V
...
.method public compress([BII[BII)I
    ...
    invoke-static/range {v0 .. v5}, Lcom/tds/lz4/LZ4JavaUnsafeCompressor;->compress64k([BII[BII)I
    ...
    .line 178
    :cond_4f
    invoke-static {v6, v2}, Lcom/tds/util/UnsafeUtils;->readInt([BI)I
    ...
    invoke-static {v14, v5}, Lcom/tds/util/UnsafeUtils;->readInt([II)I
    ...
    .line 181
    .local v4, "back":I
    invoke-static {v14, v5, v2}, Lcom/tds/util/UnsafeUtils;->writeInt([III)V
    ...
    invoke-static {v6, v3, v2}, Lcom/tds/lz4/LZ4UnsafeUtils;->readIntEquals([BII)Z
    ...
    .line 185
    invoke-static {v6, v3, v2, v7, v0}, Lcom/tds/lz4/LZ4UnsafeUtils;->commonBytesBackward([BIIII)I
    ...
    invoke-static {v9, v1, v3}, Lcom/tds/util/UnsafeUtils;->writeByte([BII)V

    .line 201
    add-int/lit8 v3, v5, -0xf

    invoke-static {v3, v9, v2}, Lcom/tds/lz4/LZ4UnsafeUtils;->writeLen(I[BI)I
    ...
    .line 207
    :goto_a1
    invoke-static {v6, v0, v9, v2, v5}, Lcom/tds/lz4/LZ4UnsafeUtils;->wildArraycopy([BI[BII)V
    ...
    .local v24, "anchor":I
    :goto_ab
    invoke-static {v9, v2, v0}, Lcom/tds/util/UnsafeUtils;->writeShortLE([BII)V
    ...
    invoke-static {v6, v5, v0, v12}, Lcom/tds/lz4/LZ4UnsafeUtils;->commonBytes([BIII)I
    ...
    .line 225
    invoke-static {v9, v1}, Lcom/tds/util/UnsafeUtils;->readByte([BI)B

    move-result v20

    or-int/lit8 v7, v20, 0xf

    invoke-static {v9, v1, v7}, Lcom/tds/util/UnsafeUtils;->writeByte([BII)V

    .line 226
    add-int/lit8 v7, v5, -0xf

    invoke-static {v7, v9, v2}, Lcom/tds/lz4/LZ4UnsafeUtils;->writeLen(I[BI)I
    ...
    invoke-static {v6, v7}, Lcom/tds/util/UnsafeUtils;->readInt([BI)I
    ...
    invoke-static {v14, v7, v3}, Lcom/tds/util/UnsafeUtils;->writeInt([III)V
    ...
    .line 242
    .local v3, "h":I
    invoke-static {v14, v3}, Lcom/tds/util/UnsafeUtils;->readInt([II)I
    ...
    .end local v26    # "ref":I
    .local v7, "ref":I
    invoke-static {v14, v3, v0}, Lcom/tds/util/UnsafeUtils;->writeInt([III)V
    ...
    invoke-static {v6, v7, v0}, Lcom/tds/lz4/LZ4UnsafeUtils;->readIntEquals([BII)Z
    ...
    invoke-static {v9, v2, v3}, Lcom/tds/util/UnsafeUtils;->writeByte([BII)V
