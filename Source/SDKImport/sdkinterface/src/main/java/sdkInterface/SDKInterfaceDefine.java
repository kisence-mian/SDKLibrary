...
public class SDKInterfaceDefine {
    ...
    //Log AD
    public static final String  Log_FunctionName_AD = "LogAD";
    public static final String  Log_ParameterName_AD_ID = "ad_id";
    public static final String  Log_ParameterName_AD_Name = "name";
    public static final String  Log_ParameterName_AD_Result = "result";
    public static final String  Log_ParameterName_AD_Cause = "cause";
